...
bookbuildeR.main <- function(sourceFile,
  ...
  files <- list( list(path=pdf,
                      desc="in the PDF&nbsp;format for reading on the computer and/or printing (but please don't print this, save paper)"),
                 list(path=epub,
                      desc="in the EPUB3&nbsp;format for reading on most mobile phones or other hand-held devices"),
                 list(path=azw3,
                      desc="in the AZW3&nbsp;format for reading on Kindle and similar devices"),
                 list(path=html,
